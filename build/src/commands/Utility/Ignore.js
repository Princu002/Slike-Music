...
export default class Ignore extends slikeCommand {
    constructor(client) {
        super(client);
        this.name = "ignore";
        this.aliases = ["ign"];
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            ...
                            .setDescription(`${this.client.emoji.cross} You don't have **Manage Guild** permissions to use this command`)
                    ],
                });
            if (!args[0])
                return message.reply({
            ...
            if (args[0].toLowerCase() === `add`) {
                ...
                if (!channel)
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guildId)
                                .setDescription(`${this.client.emoji.cross} Please provide me a valid channel`),
                        ],
                    });
                if (this.client.utils.checkIgnore(message.guildId, channel.id))
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guildId)
                                .setDescription(`${this.client.emoji.cross} This Channel ${channel} is Already in my Ignore List!`),
                        ],
                    });
                ...
                if (list.length >= 5 &&
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guildId)
                                .setDescription(`${this.client.emoji.cross} This guilds need to be a **[Premium Guild](${this.client.config.server})** in order to add more than **5 Channels in Ignore List**`)
                        ],
                    });
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            .premiumEmbed(message.guildId)
                            .setDescription(`${this.client.emoji.tick} Successfully **Added** ${channel} to the Ignore List! Now I will Ignoring all of my Commands There!`)
                    ],
                });
            }
                ...
                if (!this.client.utils.checkIgnore(message.guildId, channel.id))
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guildId)
                                .setDescription(`${this.client.emoji.cross} This Channel ${channel} is not present in my Ignore List!`),
                        ],
                    });
                    ...
                    if (check === true) {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(message.guildId)
                                    .setDescription(`${this.client.emoji.cross} **Removed** Admins from my **Ignore Bypass**`),
                            ],
                        });
                    }
                    else {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(message.guildId)
                                    .setDescription(`${this.client.emoji.tick} **Added** Admins to **Ignore Bypass**`),
                            ],
                        });
                    }
                }
                    ...
                    if (check === true) {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(message.guildId)
                                    .setDescription(`${this.client.emoji.cross} **Removed** Mods from my **Ignore Bypass**`),
                            ],
                        });
                    }
                    else {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(message.guildId)
                                    .setDescription(`${this.client.emoji.tick} **Added** Mods to my **Ignore Bypass**`),
                            ],
                        });
                    }
                }
            ...
            if (args[0].toLowerCase() === `reset`) {
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            .premiumEmbed(message.guildId)
                            .setDescription(`${this.client.emoji.tick} Successfully **Resetted** the Ignore Module!`),
                    ],
                });
            }
        };
