...
export default class Premium extends slikeCommand {
    constructor(client) {
        super(client);
        this.name = "premium";
        this.aliases = ["prem"];
                ...
                if (check.USER === null)
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guildId)
                                .setDescription(`${this.client.emoji.cross} You don't have any kind of **[Premium](${this.client.config.server})** to be activated!`)
                                .setAuthor({
                                name: `${this.client.user.username}`,
                                iconURL: this.client.user.displayAvatarURL(),
                            })
                ...
                if (cnt.COUNT === 0)
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .errorEmbed()
                                .setDescription(`${this.client.emoji.cross} You don't have any **[Premiums](${this.client.config.server})** left to be activated`)
                                .setTimestamp()
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`${this.client.emoji.cross} Your [Premium](${this.client.config.server}) has been **Expired**`),
                        ],
                    });
                }
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`${this.client.emoji.cross} This Server is already in my Premium`),
                        ],
                    });
                }
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`${this.client.emoji.cross} You premium Code seems not to be working! Please contact the support`),
                        ],
                    });
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`${this.client.emoji.tick} Successfully **Added** [Premium](${this.client.config.server}) to ${guild.name} by **${message.author.tag}**\nExpires On: <t:${premTime}> (<t:${premTime}:R>)\nExecutive Code: \`${code.CODE}\``),
                        ],
                    });
                }
            }
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .errorEmbed()
                                .setTitle(`Premium Not Found`)
                                .setDescription(`${this.client.emoji.cross} User ${user.tag} don't have any kind of [Premium](${this.client.config.server}).Please visit our [Support Server](${this.client.config.server}) to avail your Premium today!`)
                                .setTimestamp()
                                .setAuthor({
                                name: `${this.client.user.username}`,
                                iconURL: this.client.user.displayAvatarURL(),
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .errorEmbed()
                                .setTitle(`Premium Not Found`)
                                .setDescription(`${this.client.emoji.cross} You don't have any kind of [Premium](${this.client.config.server}).Please visit our [Support Server](${this.client.config.server}) to avail your Premium today!`)
                                .setTimestamp()
                                .setAuthor({
                                name: `${this.client.user.username}`,
                                iconURL: this.client.user.displayAvatarURL(),
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`${this.client.emoji.cross} This guild: \`${guild.name}\` is not in my **[Premium](${this.client.config.server})** Guilds!`)
                                .setTimestamp(),
                        ],
                    });
                }
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`${this.client.emoji.cross} You are not the activator for this guild's Premium`)
                                .setAuthor({
                                name: `${this.client.user.username}`,
                                iconURL: this.client.user.displayAvatarURL(),
                            })
                ...
                if (rem === true) {
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`${this.client.emoji.tick} Successfully **Revoked** [Premium](${this.client.config.server}) for the guild by **${message.author.tag}**`)
                                .setTimestamp(),
                        ],
                    });
                }
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .errorEmbed()
                                .setDescription(`${this.client.emoji.cross} Please contact devs!`),
                        ],
                    });
            }
