...
export default class Setup extends slikeCommand {
    constructor(client) {
        super(client);
        this.name = "setup";
        this.aliases = ["set"];
        ...
        this.exec = async (message, args, prefix) => {
            ...
            if (args[0].toLowerCase() === `player`) {
                ...
                let b1 = this.client.utils.button(`custom_id`, `slike Classic`, 2, `slike_classic_mode`);
                let b2 = this.client.utils.button(`custom_id`, `slike x Spotify`, 3, `slike_spotify_mode`);
                let b3 = this.client.utils.button(`custom_id`, `slike Simple`, 2, `slike_simple_mode`);
                let b4 = this.client.utils.button(`custom_id`, `slike Special`, 1, `slike_special_mode`);
                let b5 = this.client.utils.button(`custom_id`, `No Buttons Style`, 2, `slike_no_mode`);
                let b6 = this.client.utils.button(`custom_id`, `slike Old School`, 2, `slike_old_mode`);
            ...
            if (args[0].toLowerCase() === `dj` ||
                ...
                if (args[1].toLowerCase() === `create`) {
                    ...
                    channel.send(`https://cdn.discordapp.com/attachments/1192018482666160178/1205060716826984458/pngtree-headphones-on-a-beach-with-neon-lights-picture-image_3181406.jpg?ex=65d6ff3f&is=65c48a3f&hm=81d99868266720704b6db5d83569897a4945c886e14a0ee0cea1633e5ef49e08&`);
                    ...
                    let b3 = this.client.utils.button(`custom_id`, null, 2, `slike_dj_pause`, null, this.client.emoji.setup.pause);
