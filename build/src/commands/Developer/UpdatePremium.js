...
export default class UpdatePremium extends slikeCommand {
    constructor(client) {
        super(client);
        ...
        this.exec = async (message, args, prefix) => {
            ...
            if (!user)
                return message.reply({
                    embeds: [
                        new this.client.utils.errorEmbed().setDescription(`${this.client.emoji.cross} Please provide me a valid User`),
                    ],
                });
            if (this.client.utils.checkUserPrem(user.id) === false)
                return message.reply({
                    embeds: [
                        this.client.utils
                            .errorEmbed()
                            .setDescription(`${this.client.emoji.cross} This User ${user} is not a Premium User`),
                    ],
                });
            let count = 0;
            let tier = "unknown";
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            ...
                            .setDescription(`${this.client.emoji.cross} Please provide me a valid time period!`),
                    ],
                });
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            ...
                            .setDescription(`${this.client.emoji.tick} Successfully **Updated** Premium to ${user} for ${count} Servers\nwhich will expire on: <t:${time}> (<t:${time}:R>)\nExecutive Code: \`${code}\``),
                    ],
                });
            else
                return message.reply({
