...
const { chunk } = pkg;
export default class slikeNoprefix extends slikeCommand {
    constructor(client) {
        super(client);
        this.name = "noprefix";
        this.aliases = ["nop"];
                    ...
                    if (this.client.utils.checkGlobalNp(user.id) === true)
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`${this.client.emoji.cross} This User ${user} is already in my **All Server's No Prefix**`),
                            ],
                        });
                    else {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .successEmbed()
                                    .setDescription(`${this.client.emoji.tick} Successfully **Added** ${user} to my **All Server's No Prefix**`),
                            ],
                        });
                    }
                }
                    ...
                    if (!guild)
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`${this.client.emoji.cross} Please provide me a valid guild!`),
                            ],
                        });
                    let id = guild.id;
                    if (this.client.utils.checkGuildNp(id, user.id) === true) {
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`${this.client.emoji.cross} This User ${user} is already in ${guild.name}'s **Server No Prefix**`),
                            ],
                        });
                    }
                    else {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .successEmbed()
                                    .setDescription(`${this.client.emoji.tick} Successfully **Added** ${user} to ${guild.name}'s **Server No Prefix**`),
                            ],
                        });
                    }
                }
                ...
                if (args[2] && args[2].toLowerCase() === `all`) {
                    if (this.client.utils.checkGlobalNp(user.id) === false) {
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`${this.client.emoji.cross} This User ${user} is not present in my **All Server's No Prefix**`),
                            ],
                        });
                    }
                    else {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .successEmbed()
                                    .setDescription(`${this.client.emoji.tick} Successfully **Removed** ${user} from my **All Server's No Prefix**`),
                            ],
                        });
                    }
                }
                    ...
                    if (this.client.utils.checkGuildNp(guild.id, user.id) === false) {
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`${this.client.emoji.cross} This user ${user} is not included in ${guild.name}'s **Server No Prefix**`),
                            ],
                        });
                    }
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .successEmbed()
                                .setDescription(`${this.client.emoji.tick} Successfully **Removed** ${user.tag} from **${guild.name}'s Server Prefix**`),
                        ],
                    });
                }
            }
