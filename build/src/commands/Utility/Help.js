...
export default class Help extends slikeCommand {
    constructor(client) {
        super(client);
        this.name = "help";
        this.aliases = ["h"];
        ...
        this.exec = async (message, args, prefix) => {
            if (!args[0]) {
                let em = this.client.utils
                    ...
                    .setDescription(`<a:RedHeart:1192040124951842847> **__ABOUT SLIKE__** <a:RedHeart:1192040124951842847>\n> Slike Is A Best Premium Music Bot Made To Provide You Many Breathtaking Features And Best Quality Music.\n\n<:rb_link_red:1192043658573266976> **__IMPORTANT LINKS__** <:rb_link_red:1192043658573266976>\n> [Invite Slike](https://discord.com/api/oauth2/authorize?client_id=1080819343937507378&permissions=2184529984&scope=bot)\n> [Support Server](https://discord.gg/29BmbYkdpy)\n> [Get premium](https://discord.gg/Bn8ym9Msr6)\n> [Our Website](https://slike-music.vercel.app/)`) 
                    .addFields([
                    {
                        name: `<a:red_star:1192044614388031530>**COMMAND CATEGORIES**<a:red_star:1192044614388031530>`,
