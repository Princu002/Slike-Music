...
import { addManagement, getManagement, manageMent, removeManagement, } from "../../wrapper/db/management.js";
import pkg from "lodash";
const { chunk } = pkg;
export default class slikeManagement extends slikeCommand {
    constructor(client) {
        super(client);
        ...
        this.exec = async (message, args, prefix) => {
            ...
            if (args[0].toLowerCase() === `list` ||
                ...
                for (let i = 0; i < get.length; i++) {
                    ...
                    list.push(`[\`${i + 1}\`]. [${us.tag}](https://discord.com/users/${us.id}) (ID: ${us.id})`);
                }
                if (list.length < 11) {
                    return message.reply({
                        embeds: [
