...
export default class Profile extends slikeCommand {
    constructor(client) {
        super(client);
        this.name = "profile";
        ...
        this.exec = async (message, args, prefix) => {
            ...
            mem = mem.data;
            let sikku = mem?.roles;
            if (user.id === "881558378667716639")
                badges += `\n<a:owner:1191368481669652560> **[! Pʀιηcє<3](https://discord.com/users/881558378667716639)**`;
            ...
            if (sikku?.includes(badge.communityManager))
                badges += `\n<:manager:1191420905197424671> **Comunity Manager**`;
            ...
            if (sikku?.includes(badge.bug))
                badges += `\n<:BugHunter2:1191999406027845633> **Bug hunter**`;
