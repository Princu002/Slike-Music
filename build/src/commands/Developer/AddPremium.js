...
export default class AddPremium extends slikeCommand {
    constructor(client) {
        super(client);
            ...
            if (this.client.utils.checkUserPrem(user.id))
                return message.reply({
                    embeds: [
                        this.client.utils
                            .errorEmbed()
                            .setDescription(`${this.client.emoji.cross} This User is already a Premium User! Try updating premium by \`updatePremium\` Command`),
                    ],
                });
                ...
                return message.reply({
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .setDescription(`${this.client.emoji.tick} Successfully **Added** Premium to ${user} for ${count} Servers\nwhich will expire on: <t:${time}> (<t:${time}:R>)\nExecutive Code: \`${code}\``),
                    ],
                });
            else
                return message.reply({
